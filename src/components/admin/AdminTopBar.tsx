import { Bell, User, Search, Home, Menu } from 'lucide-react';
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <div className="relative hidden sm:block">
            ...
            <input
              type="text"
              placeholder="جستجو..."
              className="pl-10 pr-4 py-2 bg-muted border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary w-48 md:w-64"
            />
          </div>
        </div>
